...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/video/video":11,"./utils/ios-vh-fix":14,"./vendor":16,"./vendor/init-accordion":18,"./vendor/init-tabs":19}],2:[function(require,module,exports){
"use strict";
...
function initSliders() {
  var trainersSlider = new _swiper.default('.trainers__items', {
  ...
  var reviewsSlider = new _swiper.default('.reviews__items', {
    direction: 'horizontal',
    navigation: {
